...
foreach ($users as &$u) {
    ...
    if ($u['last_login']) {
        ...
        if ($diff <= 1800) $onlineNow++;
        if ($diff < 60) {
            $u['last_login_ago'] = 'Baru saja';
        } elseif ($diff < 3600) {
            $u['last_login_ago'] = floor($diff / 60) . ' menit lalu';
        } elseif ($diff < 86400) {
            $u['last_login_ago'] = floor($diff / 3600) . ' jam lalu';
        } else {
            $u['last_login_ago'] = floor($diff / 86400) . ' hari lalu';
        }
    } else {
        $u['last_login_ago'] = 'Belum pernah';
    }
}
unset($u);
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Online Sekarang <small class="text-muted">(30 menit)</small></div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center align-middle">
                            <div style="width:38px;height:38px;border-radius:50%;background:<?php echo $avatarBg; ?>;color:<?php echo $avatarTextColor; ?>;display:inline-flex;align-items:center;justify-content:center;font-weight:700;font-size:1rem;">
                        ...
                        <td class="align-middle text-nowrap">
                            <button class="btn btn-sm btn-primary btn-edit mr-1"
                                data-id="<?php echo $u['id']; ?>"
                                title="Edit" data-toggle="tooltip">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-warning btn-reset-pwd mr-1"
                                data-id="<?php echo $u['id']; ?>"
                            ...
                            <button class="btn btn-sm <?php echo $u['is_active'] ? 'btn-danger' : 'btn-success'; ?> btn-toggle-active"
                                data-id="<?php echo $u['id']; ?>"
                                data-active="<?php echo $u['is_active']; ?>"
                                data-name="<?php echo htmlspecialchars($u['full_name'], ENT_QUOTES); ?>"
                                title="<?php echo $u['is_active'] ? 'Nonaktifkan' : 'Aktifkan'; ?>" data-toggle="tooltip">
                                <i class="fas <?php echo $u['is_active'] ? 'fa-user-slash' : 'fa-user-check'; ?>"></i>
                            </button>
                            <?php else: ?>
                            <button class="btn btn-sm btn-secondary" disabled title="Tidak bisa menonaktifkan akun sendiri" data-toggle="tooltip">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="full_name" id="add_full_name" required placeholder="Masukkan nama lengkap">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Username <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="username" id="add_username" required placeholder="Masukkan username">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="add_email" required placeholder="Masukkan email">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" id="add_password" required placeholder="Minimal 6 karakter">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Konfirmasi Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" name="confirm_password" id="add_confirm_password" required placeholder="Ulangi password">
                                <div class="invalid-feedback" id="add_pwd_mismatch">Password tidak cocok.</div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="add_is_active">Aktifkan pengguna ini</label>
                        </div>
                    </div>
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="editUserModalLabel"><i class="fas fa-edit mr-2"></i>Edit Pengguna</h5>
                <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="full_name" id="edit_full_name" placeholder="Nama lengkap">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" id="edit_password" placeholder="Minimal 6 karakter">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Konfirmasi Password Baru</label>
                                <input type="password" class="form-control" name="confirm_password" id="edit_confirm_password" placeholder="Ulangi password baru">
                                <div class="invalid-feedback" id="edit_pwd_mismatch">Password tidak cocok.</div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="edit_is_active">Pengguna aktif</label>
                        </div>
                    </div>
            ...
            <form id="resetPwdForm" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="new_password" id="reset_new_password" required placeholder="Minimal 6 karakter">
                    </div>
                    <div class="form-group">
                        <label>Konfirmasi Password Baru <span class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="reset_confirm_password" required placeholder="Ulangi password baru">
                        <div class="invalid-feedback" id="reset_pwd_mismatch">Password tidak cocok.</div>
                    </div>
...
$(document).ready(function () {
    ...
    $('#addUserForm').on('submit', function (e) {
        ...
        $('#addUserBtn').prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-1"></i> Menyimpan...');
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    showModalAlert('addUserAlert', res.message || 'Gagal menambahkan pengguna.', 'danger');
                }
            },
            error: function () {
                showModalAlert('addUserAlert', 'Terjadi kesalahan jaringan.', 'danger');
            },
            complete: function () {
                $('#addUserBtn').prop('disabled', false).html('<i class="fas fa-save mr-1"></i> Simpan');
            }
        });
    });
    ...
    $('#editUserForm').on('submit', function (e) {
        ...
        $('#editUserBtn').prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-1"></i> Menyimpan...');
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    showModalAlert('editUserAlert', res.message || 'Gagal memperbarui pengguna.', 'danger');
                }
            },
            error: function () {
                showModalAlert('editUserAlert', 'Terjadi kesalahan jaringan.', 'danger');
            },
            complete: function () {
    ...
    $('#resetPwdForm').on('submit', function (e) {
        ...
        $('#resetPwdBtn').prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-1"></i> Mereset...');
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    showModalAlert('resetPwdAlert', res.message || 'Gagal mereset password.', 'danger');
                }
            },
            error: function () {
                showModalAlert('resetPwdAlert', 'Terjadi kesalahan jaringan.', 'danger');
            },
            complete: function () {
