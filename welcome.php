...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Sora:wght@300;400;600;700;800&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,400&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *::after {
        ...
        .gauge-bar-f {
            ...
            border-radius: 3px;
            width: 0;
            transition: width 1.8s cubic-bezier(.4, 0, .2, 1) .5s;
        }
        ...
        .feq-p {
            border-color: rgba(28, 200, 138, .5);
            color: #5ce0ab;
        ...
        .cls-ok {
            border-color: rgba(246, 194, 62, .4);
            background: rgba(246, 194, 62, .07);
        }
        ...
        .cls-low {
            border-color: rgba(168, 38, 38, .4);
            background: rgba(168, 38, 38, .07);
        }
        ...
        .h-dot {
            ...
            border-radius: 50%;
            opacity: 0;
            animation: hRise linear infinite;
        }
        ...
        @keyframes hRise {
            ...
            100% {
                transform: translateY(-8%) translateX(var(--dx));
                opacity: 0;
            }
        }
        ...
        .float-icon {
            ...
            z-index: 1;
            font-size: 1.1rem;
            color: rgba(180, 60, 60, .35);
            animation: floatIcon ease-in-out infinite alternate;
            pointer-events: none;
        }
        ...
        .scanline {
            ...
            right: 0;
            height: 2px;
            background: linear-gradient(90deg, transparent, rgba(196, 48, 48, .35), transparent);
        ...
        @keyframes gaugeGlow {
            ...
            0%,
            100% {
                filter: drop-shadow(0 0 4px rgba(196, 48, 48, .3));
            }

            50% {
                filter: drop-shadow(0 0 14px rgba(196, 48, 48, .7));
            }
        }
        ...
        .sec-head h2::after {
            ...
            height: 3px;
            margin-top: 10px;
            background: linear-gradient(90deg, var(--m300), var(--mlight));
            border-radius: 2px;
        }

        /* Feat card hover glow */
        .feat-card {
            position: relative;
            overflow: hidden;
        }
        ...
        .feat-card::after {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at 50% 0%, rgba(168, 38, 38, .12), transparent 70%);
            opacity: 0;
        ...
        /* Data stream lines in hero bg */
        .data-line {
            position: absolute;
            width: 1px;
            background: linear-gradient(180deg, transparent, rgba(196, 48, 48, .25), transparent);
        ...
        .gauge-pulse {
            ...
            inset: -8px;
            border-radius: 50%;
            border: 2px solid rgba(196, 48, 48, .25);
...
<body>
    ...
    <nav id="nav">
        <div class="nav-brand">
            <img src="img/yanmar.png" alt="Yanmar" style="height:28px;object-fit:contain;">
            OEE Monitoring
        </div>
        <ul class="nav-links">
    ...
    <section id="hero">
        ...
        <div id="hero-blobs">
            <div class="h-blob"
                style="width:600px;height:600px;background:radial-gradient(circle,rgba(139,26,26,.45),transparent 70%);top:-200px;left:-100px;--tx:30px;--ty:20px;animation-duration:8s;">
            </div>
            <div class="h-blob"
                style="width:500px;height:500px;background:radial-gradient(circle,rgba(80,10,10,.35),transparent 70%);bottom:-150px;right:-100px;--tx:-20px;--ty:-30px;animation-duration:11s;">
            </div>
            <div class="h-blob"
                style="width:350px;height:350px;background:radial-gradient(circle,rgba(168,38,38,.2),transparent 70%);top:40%;left:40%;--tx:15px;--ty:-15px;animation-duration:9s;animation-delay:-4s;">
            </div>
        </div>
        <!-- Particles -->
        ...
        <div class="data-line" style="left:15%;height:200px;animation-duration:4s;animation-delay:0s;"></div>
        <div class="data-line" style="left:30%;height:140px;animation-duration:6s;animation-delay:-2s;"></div>
        <div class="data-line" style="left:65%;height:180px;animation-duration:5s;animation-delay:-1s;"></div>
        <div class="data-line" style="left:80%;height:120px;animation-duration:7s;animation-delay:-3s;"></div>
        <!-- Floating icons -->
        <div class="float-icon" style="top:18%;left:8%;animation-duration:3.5s;"><i class="fas fa-cogs"></i></div>
        <div class="float-icon" style="top:60%;left:5%;animation-duration:4.2s;animation-delay:-1s;"><i
                class="fas fa-chart-line"></i></div>
        <div class="float-icon" style="top:25%;left:55%;animation-duration:5s;animation-delay:-2s;font-size:.85rem;"><i
                class="fas fa-microchip"></i></div>
        <div class="float-icon" style="top:70%;left:52%;animation-duration:3.8s;animation-delay:-0.5s;"><i
                class="fas fa-wave-square"></i></div>

        <div class="container">
            <div class="hero-inner">
                <div class="hero-left">
                    <div class="hero-tag reveal">
                        <span class="tag"><i class="fas fa-industry" style="margin-right:6px;"></i>Production Monitoring
                            System</span>
                    </div>
                    ...
                    <div class="hero-meta reveal">
                        <div class="hero-meta-item">
                            ...
                            <div class="hero-meta-lbl">Target OEE</div>
                        </div>
                        <div class="hero-meta-item">
                        ...
                        <div class="hero-meta-item">
                            <div class="hero-meta-num" style="color:#5ce0ab;">
                                <span class="cnt" data-t="8">8</span> Sensors
                            </div>
                            <div class="hero-meta-lbl">Healthy Check</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hero-right reveal">
                    <div class="gauge-box">
                        ...
                        <div class="gauge-svg-wrap">
                            <div class="gauge-pulse"></div>
                            <svg width="200" height="200" viewBox="0 0 200 200">
                                <!-- tracks (r: 82, 64, 47, 31) -->
                                <circle cx="100" cy="100" r="82" fill="none" stroke="rgba(255,255,255,.07)"
                                    stroke-width="14" />
                                <circle cx="100" cy="100" r="64" fill="none" stroke="rgba(255,255,255,.07)"
                                    stroke-width="10" />
                                <circle cx="100" cy="100" r="47" fill="none" stroke="rgba(255,255,255,.07)"
                                    stroke-width="10" />
                                <circle cx="100" cy="100" r="31" fill="none" stroke="rgba(255,255,255,.07)"
                                    stroke-width="7" />
                                <!-- fills -->
                                <!-- OEE  r=82  c=515 -->
                                <circle id="gOEE" cx="100" cy="100" r="82" fill="none" stroke="#c43030"
                                    stroke-width="14" stroke-linecap="round" stroke-dasharray="515"
                                    stroke-dashoffset="515"
                                    style="transition:stroke-dashoffset 2s cubic-bezier(.4,0,.2,1) .3s" />
                                <!-- A    r=64  c=402 -->
                                <circle id="gA" cx="100" cy="100" r="64" fill="none" stroke="#7c9ef5" stroke-width="10"
                                ...
                                <!-- P    r=47  c=295 -->
                                <circle id="gP" cx="100" cy="100" r="47" fill="none" stroke="#5ce0ab" stroke-width="10"
                                ...
                                <!-- Q    r=31  c=195 -->
                                <circle id="gQ" cx="100" cy="100" r="31" fill="none" stroke="#f5d278" stroke-width="7"
            ...
            <div class="reveal">
                ...
                <table class="example-table">
                    <tr>
                        ...
                        <td class="ex-bar">
                            <div class="ex-bar-t">
                                <div class="ex-bar-f" style="background:#7c9ef5;" data-w="90"></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ex-bar">
                            <div class="ex-bar-t">
                                <div class="ex-bar-f" style="background:#5ce0ab;" data-w="95"></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ex-bar">
                            <div class="ex-bar-t">
                                <div class="ex-bar-f" style="background:#f5d278;" data-w="99"></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="ex-name" style="color:var(--text);font-family:'Sora',sans-serif;font-weight:700;">OEE
                        </td>
    ...
    <script>
        // Particles
        (function () {
            var c = document.getElementById('particles-hero');
            if (!c) return;
            for (var n = 0; n < 50; n++) {
                var p = document.createElement('div'); p.className = 'h-dot';
                var r = Math.random();
                var col = r > .65 ? 'rgba(228,84,84,.5)' : r > .4 ? 'rgba(196,48,48,.35)' : 'rgba(255,255,255,.2)';
            ...
            setTimeout(function () {
                ...
                document.querySelectorAll('.cnt').forEach(function (el) {
                    ...
                    var t = setInterval(function () {
                        ...
                        if (n >= target) {
                            clearInterval(t);
                            el.closest('.hero-meta-num').style.animation = 'digitPop .4s ease';
                            setTimeout(function () { el.closest('.hero-meta-num').style.animation = ''; }, 400);
                        }
                    }, 20);
                });
            }, 500);
